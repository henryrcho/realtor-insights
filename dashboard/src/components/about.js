        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8 px-0">
                    <h4 class="text-left">Realstor Insights</h4>
                    <p class="lead my-3 text-left">
                    ...
                    <h4 class="text-left">The Assessor Research Tool</h4>
                    <p class="lead my-3 text-left">
                    ...
                    <h4 class="text-left">Team</h4>
                    <p class="lead my-3 text-left mb-5">
